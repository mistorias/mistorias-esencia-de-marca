...
- No simplifica de forma engañosa
- No se queda en lo superficial
- No usa un tono académico distante

Uso del humor:
- Sutil, inteligente, humano
- Hace visible lo absurdo de ciertas desigualdades
- Nunca minimiza el problema

---

## 10. Identidad visual

### 10.1 Concepto visual: "Ascending Data"
...
- Uso: H1, navegación, botones, datos numéricos
- Pesos: Bold 700, SemiBold 600, Regular 400

Lora (Narrativa):
- Uso: H2, body text, historias, análisis
...
- Fuentes visibles
- Contexto explicado
- Honestidad sobre límites de los datos
- Trazabilidad entre historia, dato e interpretación

---

## 14. Regla de oro editorial
